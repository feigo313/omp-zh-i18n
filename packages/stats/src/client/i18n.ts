...
const translations: Record<Locale, Record<string, string>> = {
	en: {
		...
		"providers.trend.title": "Burn by Provider",
		"providers.trend.subtitle": "Stacked token/cost burn per provider over time",
		"providers.peak.title": "Peak Burn Hours",
		"providers.peak.subtitle": "Token burn by local hour of day",
		"providers.peak.subtitlePeak": "Token burn by local hour of day - peak at {hour}",
		...
		"providers.columns.requests": "Requests",
		"providers.columns.models": "Models",
		"providers.columns.share": "Share",
		"providers.columns.tps": "Tok/s",
		"providers.columns.window": "Window",
		"providers.columns.accounts": "Accounts",
		"providers.columns.windowsBurned": "Windows Burned",
		"providers.columns.estTokensPerWindow": "Est. Tokens / Window",
		"providers.columns.peakUtilization": "Peak Utilization",
		"providers.columns.idealAccounts": "Ideal Accounts",
		"providers.columns.exhaustions": "Exhaustions",
		"providers.tooltip.tokenBreakdown":
			"Input {input} - Output {output} - Cache read {cacheRead} - Cache write {cacheWrite}",
		"providers.tooltip.windowsBurned":
			"Subscription-window equivalents consumed in range (sum of used-fraction increases across accounts)",
		"providers.tooltip.estTokensPerWindow":
			"Provider tokens burned in range / windows burned - what one full window is worth",
		"providers.tooltip.peakUtilization": "Peak of summed used fraction across accounts at any sampled instant",
		"providers.tooltip.idealAccounts": "Accounts needed to keep peak demand under 90% of fleet capacity",
		"providers.total": "Total: {value}",
		"providers.all": "All providers",
		"providers.have": "have {count}",
		"providers.used": "Used",
		"providers.recorded": "recorded {time}",
		"providers.noRequests": "No requests recorded in this range",
		"providers.noActivity": "No provider activity in this range",
		"providers.windows.noSnapshots":
			"No usage snapshots recorded yet - they accumulate whenever usage is fetched (TUI footer, /usage, omp usage)",
		"providers.utilization.noSnapshots":
	...
	zh: {
		...
		"providers.trend.title": "按提供商统计消耗",
		"providers.trend.subtitle": "按时间展示各提供商的 Token/成本堆叠消耗",
		"providers.peak.title": "消耗高峰时段",
		"providers.peak.subtitle": "按本地小时统计 Token 消耗",
		"providers.peak.subtitlePeak": "按本地小时统计 Token 消耗 - 高峰在 {hour}",
		"providers.windows.title": "订阅窗口",
		"providers.windows.subtitle": "各使用窗口可提供的额度，以及峰值需求所需的账号数量",
		"providers.utilization.title": "窗口利用率",
		"providers.utilization.subtitle": "各账号和窗口的最新额度利用率 - 红色表示耗尽，琥珀色表示超过 80%",
		"providers.columns.requests": "请求数",
		"providers.columns.models": "模型数",
		"providers.columns.share": "占比",
		"providers.columns.tps": "Token/秒",
		"providers.columns.window": "窗口",
		"providers.columns.accounts": "账号数",
		"providers.columns.windowsBurned": "已消耗窗口",
		"providers.columns.estTokensPerWindow": "预计 Token/窗口",
		"providers.columns.peakUtilization": "峰值利用率",
		"providers.columns.idealAccounts": "理想账号数",
		"providers.columns.exhaustions": "耗尽次数",
		"providers.tooltip.tokenBreakdown": "输入 {input} - 输出 {output} - 缓存读取 {cacheRead} - 缓存写入 {cacheWrite}",
		"providers.tooltip.windowsBurned": "此范围内消耗的订阅窗口等价数（各账号使用比例增量之和）",
		"providers.tooltip.estTokensPerWindow": "此范围消耗的提供商 Token / 已消耗窗口数 - 一个完整窗口的估算额度",
		"providers.tooltip.peakUtilization": "任意采样时刻各账号使用比例之和的峰值",
		"providers.tooltip.idealAccounts": "将峰值需求保持在集群容量 90% 以下所需的账号数",
		"providers.total": "总计：{value}",
		"providers.all": "所有提供商",
		"providers.have": "已有 {count}",
		"providers.used": "已使用",
		"providers.recorded": "记录于 {time}",
		"providers.noRequests": "此范围内没有请求记录",
		"providers.noActivity": "此范围内没有提供商活动",
		"providers.windows.noSnapshots": "尚无使用快照 - 每次获取用量时累积（TUI 页脚、/usage、omp usage）",
		"providers.utilization.noSnapshots": "尚无使用快照 - 每次获取用量时累积",
