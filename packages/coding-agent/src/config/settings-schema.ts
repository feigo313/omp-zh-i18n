...
export const SETTINGS_SCHEMA = {
	...
	"advisor.syncBacklog": {
		...
		ui: {
			...
			options: [
				{ value: "off", label: "Off", description: "Disable catch-up delays" },
	...
	"tui.hyperlinks": {
		...
		ui: {
			...
			options: [
				{ value: "off", label: "Off", description: "Never wrap paths/URLs in hyperlinks" },
				{ value: "auto", label: "Auto", description: "Detect terminal hyperlinks support" },
				{ value: "always", label: "Always", description: "Always wrap paths/URLs in hyperlinks" },
			],
		},
	},
	"tui.tight": {
	...
	steeringMode: {
		...
		ui: {
			...
			options: [
				...
				{ value: "one-at-a-time", label: "One at a Time", description: "Process messages sequentially" },
			],
		},
	},
	...
	followUpMode: {
		...
		ui: {
			...
			options: [
				{ value: "all", label: "All", description: "Process all follow-up messages at once" },
				{ value: "one-at-a-time", label: "One at a Time", description: "Process follow-up messages sequentially" },
			],
		},
	},
	...
	interruptMode: {
		...
		ui: {
			...
			options: [
				{ value: "immediate", label: "Immediate", description: "Interrupt tool execution right away" },
				{ value: "wait", label: "Wait", description: "Wait for current tool call to finish before processing" },
			],
		},
	},
	...
	doubleEscapeAction: {
		...
		ui: {
			...
			options: [
				{ value: "branch", label: "Branch", description: "Switch to the previous session branch" },
				{ value: "tree", label: "Session Tree", description: "Open the session tree view" },
				{ value: "none", label: "None", description: "Do nothing on double-escape" },
			],
		},
	},
	...
	treeFilterMode: {
		...
		ui: {
			...
			options: [
				{ value: "default", label: "Default", description: "Use the default filter" },
				{ value: "no-tools", label: "No Tools", description: "Hide tool-call messages" },
				{ value: "user-only", label: "User Only", description: "Show only user messages" },
				{ value: "labeled-only", label: "Labeled Only", description: "Show only messages with labels" },
				{ value: "all", label: "All", description: "Show all messages" },
			],
		},
	},
	...
	"completion.notify": {
		...
		ui: {
			...
			options: [
				{ value: "on", label: "On", description: "Show notification when agent finishes" },
				{ value: "off", label: "Off", description: "Disable completion notification" },
			],
		},
	},
	...
	"ask.notify": {
		...
		ui: {
			...
			options: [
				{ value: "on", label: "On", description: "Show notification when ask tool is waiting" },
				{ value: "off", label: "Off", description: "Disable ask notification" },
			],
		},
	},
	...
	"hindsight.recallBudget": {
		...
		ui: {
			...
			description: "Recall budget for Hindsight memory queries",
			condition: "hindsightActive",
			options: [
				{ value: "low", label: "Low", description: "Fewer memories recalled" },
				{ value: "mid", label: "Medium", description: "Balanced recall amount" },
				{ value: "high", label: "High", description: "More memories recalled" },
			],
		},
	},
	...
	"ttsr.contextMode": {
		...
		ui: {
			...
			options: [
				{ value: "discard", label: "Discard", description: "Drop the partial output when TTSR interrupts" },
				{ value: "keep", label: "Keep", description: "Retain the partial output even when TTSR interrupts" },
			],
		},
	},
	...
	"ttsr.repeatMode": {
		...
		ui: {
			...
			options: [
				{ value: "once", label: "Once", description: "Each rule triggers only once per session" },
				{ value: "after-gap", label: "After Gap", description: "Rule can repeat after a gap in messages" },
			],
		},
	},
	...
	"shellMinimizer.sourceOutlineLevel": {
		...
		ui: {
			...
			options: [
				{ value: "default", label: "Default", description: "Standard source outline compression" },
				{ value: "aggressive", label: "Aggressive", description: "More aggressive source outline compression" },
			],
		},
	},
	...
	"python.kernelMode": {
		...
		ui: {
			...
			options: [
				{ value: "session", label: "Session", description: "Keep kernel alive across all eval calls in a session" },
				{ value: "per-call", label: "Per Call", description: "Start a fresh kernel for each eval call" },
			],
		},
	},
	"python.interpreter": {
	...
	"dev.autoqaConsent": {
		...
		ui: {
			...
			description: "Decision on sharing automatic report_tool_issue grievances",
			options: [
				{ value: "unset", label: "Unset", description: "Never asked; first invocation shows consent dialog" },
				{ value: "granted", label: "Granted", description: "Allow sending grievances to the push endpoint" },
				{ value: "denied", label: "Denied", description: "Silently disable all report_tool_issue calls" },
			],
		},
	},
